...
sudo -E docker pull docker-registry.pdbld.f5net.com/openstack-test-ansibleserver-prod/ocata
sudo -E docker run \
    --volumes-from `hostname | xargs` \
docker-registry.pdbld.f5net.com/openstack-test-ansibleserver-prod/ocata:latest \
